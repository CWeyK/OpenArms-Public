...
<body class="overflow-hidden">
    <div class="mainContent m-0">
        <div class="contactContainer">
            <div class="d-flex card flex-row align-items-center" style="padding:2rem 2rem 2rem 4rem;">

                <div style="width: 300px; margin-right: 4rem;">
                    <p class="fs-6 fw-bold mb-1" style="color: #769fcd;">
                ...
                <img src="./images/map.jpg" style="height: 400px; width: 400px;"/>
            </div>
        </div>
    </div>
</body>
